 ...
 * 
 */
public class TGameObject<T> implements GameEntity {
	 ...
	 * @param name
	 */
	public TGameObject(String name) {
		this.name = name;
	}
	 ...
	 * @param image
	 */
	public TGameObject(String name, int x, int y, BufferedImage image) {
		this(name);
		moveTo(x, y);
	}
	...
	/**
	 * Adapt Bounding box for this object.
	 * 
	 * @param o
	 */
	private void computeBoundingBox(TGameObject<T> o) {
	 ...
	 * @return
	 */
	public TGameObject<T> moveTo(float x, float y) {
		this.position.x = x;
		this.position.y = y;
	 ...
	 * @return
	 */
	public TGameObject<T> setVelocity(float dx, float dy) {
		this.speed.x = dx;
		this.speed.y = dy;
		return this;
	}
	 ...
	 * @return
	 */
	public TGameObject<T> setSize(int width, int height) {
		this.size.x = width;
		this.size.y = height;
		computeBoundingBox(this);
		return this;
	 ...
	 * @return
	 */
	public TGameObject<T> setImage(BufferedImage image) {
		this.image = image;
		return this;
	}
	 ...
	 * @return
	 */
	public TGameObject<T> setColor(Color color) {
		this.color = color;
		return this;
	}
	 ...
	 * @return
	 */
	public TGameObject<T> setLayer(int layer) {
		this.layer = layer;
		return this;
	}
	 ...
	 * @return
	 */
	public TGameObject<T> setPriority(int priority) {
	 ...
	 * @return
	 */
	public TGameObject<T> setElasticity(float elasticity) {
	 ...
	 * @return
	 */
	public TGameObject<T> setFriction(float friction) {
	 ...
	 */
	public TGameObject<T> setBoundingType(BoundingBoxType type) {
	...
	protected T builder(String name){
        ...
        try {
			objectInstance = (T) Class.forName(parameterClassName).newInstance();
	...
	public TGameObject<T> setScale(float f) {
		this.scale = f;
		return this;
	}
	 ...
	 * @return
	 */
	public TGameObject<T> setPhysic(Physic type) {
		this.type = type;
		return this;
	}
	 ...
	 */
	public TGameObject<T> setFixed(boolean fixedFlag) {
	 ...
	 * @return
	 */
	public TGameObject<T> setDebugInfoOffset(Vector2D debugDisplayOffset) {
